$(document).ready(function() {
    ...
    function showInformationDialog(files, objectArray) {
        ...
        for (var i = 0; i < objectArray.length; i++) {
            ...
            for ( var infoKey in infoObject) {
                if (infoObject.hasOwnProperty(infoKey)) {
                    responseContent = responseContent + " " + "<b style='color: #ff662a'>" + infoKey + "</b> : " + "<b style='color: #ffd339'>" + infoObject[infoKey] + "</b>" + "<br>";
                }
            }
        ...
        BootstrapDialog.show({
            title : '<b>Congrats, You have uploaded image(s) to server success!</b>',
